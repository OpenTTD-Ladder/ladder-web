...
from .context import TEMPLATE_CONTEXT_PROCESSORS
from .databases import DATABASES, DATABASE_ROUTERS
from .debug_toolbar import ENABLE_DEBUG_TOOLBAR, DEBUG_TOOLBAR_PANELS, DEBUG_TOOLBAR_CONFIG, TEMPLATE_TIMINGS_SETTINGS
...
SECRET_KEY = 'hp4_fkh=a(64x%a7#6)i%d@036@+)duzp10h+loo0de0#n&c&v'
